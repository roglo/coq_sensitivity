...
symmetry in Hx.
specialize (rngl_1_add_cos_div_2_nonneg θ) as Hz1ac.
specialize (rngl_1_sub_cos_div_2_nonneg θ) as Hz1sc.
destruct x. 2: {
  exfalso.
...
destruct (rngl_eq_dec Hed (rngl_cos θ) (-1)%L) as [Ht1| Ht1]. {
  ...
  induction n; intros. {
    cbn.
    apply (rngl_cos_lt_sqrt_1_add_cos_div_2 Hc1); [ easy | ].
...
intros * H123 H23.
remember (θ3 =? 0)%A as z3 eqn:Hz3.
symmetry in Hz3.
destruct z3. {
  apply (angle_eqb_eq Hed) in Hz3.
  subst θ3.
  now rewrite angle_add_0_r in H123.
}
apply (angle_eqb_neq Hed) in Hz3.
...
destruct zs1. {
  ...
  destruct zs123. {
    ...
    destruct zs2. {
      ...
      destruct H as [H| H]. {
        rewrite H in Hc12s1.
        apply (rngl_nle_gt Hor) in Hc12s1.
        apply Hc12s1; clear Hc12s1.
        apply rngl_sin_bound.
      }
      apply angle_add_sub_eq_l in H.
      subst θ2.
      progress sin_cos_add_sub_straight_hyp Hzs2.
      apply (rngl_le_antisymm Hor) in Hzs2; [ | easy ].
      symmetry in Hzs2.
      ...
      destruct zc1. {
        ...
        destruct H as [H| H]. {
          ...
          destruct H'; subst θ2. {
            ...
            now rewrite angle_sub_diag in H.
          }
          cbn in Hzs2.
...
(**)
      ...
      progress sin_cos_add_sub_straight_hyp Hzs1.
      progress sin_cos_add_sub_straight_hyp Hzs123.
      progress sin_cos_add_sub_straight_hyp H123.
      progress sin_cos_add_sub_straight_hyp Hzc1.
      progress sin_cos_add_sub_straight_hyp Hzs12.
...
...
      ...
      remember (θ1 + θ2)%A as θ; cbn; subst θ.
...
      progress sin_cos_add_sub_right_goal T.
      progress sin_cos_add_sub_right_hyp T Hzs1.
      progress sin_cos_add_sub_right_hyp T Hzs1.
