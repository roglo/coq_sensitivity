...
apply (rngl_lt_le_incl Hor) in H.
...
generalize H23; intros H.
apply rngl_cos_cos_sin_sin_nonneg_sin_le_cos_le_iff in H; try easy.
...
About angle_add_le_mono_l_lemma_1.
About rngl_sin_nonneg_cos_le_sin_le.
*)
...
