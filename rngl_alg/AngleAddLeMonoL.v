...
destruct zs2. {
  ...
  destruct (rngl_le_dec Hor 0 (rngl_cos θ1)) as [Hzc1| Hc1z]. {
    ...
    progress sin_cos_add_sub_straight_hyp Haov.
    progress sin_cos_add_sub_straight_hyp Hzs2.
    progress sin_cos_add_sub_straight_hyp Hc2z.
    progress sin_cos_add_sub_straight_hyp Hc12.
    exfalso.
    apply (rngl_nlt_ge Hor) in Haov.
  ...
  progress sin_cos_add_sub_straight_hyp Hc1z.
  progress sin_cos_add_sub_straight_hyp Hc12.
...
progress sin_cos_add_sub_straight_hyp Hs1z.
progress sin_cos_add_sub_straight_hyp Hzs13.
...
destruct (rngl_le_dec Hor (rngl_cos θ2) 0)%L as [Hc2z| Hzc2]. {
  exfalso.
  change_angle_add_r θ2 angle_straight.
  progress sin_cos_add_sub_straight_hyp H23.
  progress sin_cos_add_sub_straight_hyp Hzs2.
  progress sin_cos_add_sub_straight_hyp Hzs12.
  progress sin_cos_add_sub_straight_hyp Hc2z.
...
progress sin_cos_add_sub_straight_hyp Hs1z.
progress sin_cos_add_sub_straight_hyp Hc1z.
progress sin_cos_add_sub_straight_hyp Hs13z.
progress sin_cos_add_sub_straight_hyp Hs12z.
progress sin_cos_add_sub_straight_goal T.
...
progress sin_cos_add_sub_straight_hyp Hzs13.
progress sin_cos_add_sub_straight_hyp Hc3z.
progress sin_cos_add_sub_straight_hyp Hzs3.
...
destruct (rngl_lt_dec Hor (rngl_sin θ1) 0) as [Hs1z| Hzs1]. {
  ...
  destruct (rngl_lt_dec Hor 0 (rngl_cos θ2)) as [Hzc2| Hc2z]. {
    ...
    destruct (rngl_le_dec Hor 0 (rngl_cos θ3)) as [Hzc3| Hc3z]. {
      ...
      change_angle_add_r θ3 angle_straight.
      progress sin_cos_add_sub_straight_hyp Hzs3.
      progress sin_cos_add_sub_straight_hyp Hs13.
      progress sin_cos_add_sub_straight_hyp H23.
      progress sin_cos_add_sub_straight_hyp Hzs13.
      progress sin_cos_add_sub_straight_hyp Hc3z.
      progress sin_cos_add_sub_straight_goal T.
...
progress unfold angle_add_overflow.
progress unfold angle_ltb.
progress sin_cos_add_sub_straight_hyp Haov13.
generalize Hzs13; intros H.
apply (rngl_lt_le_incl Hor) in H.
apply rngl_leb_le in H.
rewrite H; clear H.
