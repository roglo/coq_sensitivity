...
(**)
          ...
          destruct n. {
            ...
            destruct i. {
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle (2 ^ 4 / 3) 3 (θ / ₂)) as H1.
              assert (H : 2 ^ 4 / 3 ≤ 2 ^ 3) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
            ...
            destruct i. {
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle (2 ^ 5 / 3) 4 (θ / ₂)) as H1.
              assert (H : 2 ^ 5 / 3 ≤ 2 ^ 4) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
              apply angle_nlt_ge in H1.
            ...
            destruct i. {
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle (2 ^ 6 / 3) 5 (θ / ₂)) as H1.
              assert (H : 2 ^ 6 / 3 ≤ 2 ^ 5) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
              apply angle_nlt_ge in H1.
            ...
            destruct i. {
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle (2 ^ 7 / 3) 6 (θ / ₂)) as H1.
              assert (H : 2 ^ 7 / 3 ≤ 2 ^ 6) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
              apply angle_nlt_ge in H1.
...
...
          ...
          destruct i. {
            cbn in Hni.
            replace n with 2 by flia Hni Hmi.
            cbn.
          ...
          destruct i. {
            ...
            destruct (le_dec n 1) as [Hn1| Hn1]. {
              rewrite (Nat_div_less_small 2); [ | cbn; flia Hn1 ].
              rewrite angle_div_2_pow_succ_r_1.
              rewrite angle_div_2_mul_2.
              now apply (angle_div_2_not_straight Hc1).
            }
            ...
            apply Nat.succ_le_mono in Hni.
            rewrite (Nat_div_less_small 1); [ | cbn; flia Hn1 Hni ].
            rewrite angle_mul_1_l.
            now apply (angle_div_2_not_straight Hc1).
          }
          destruct i. {
            ...
            destruct n. {
              cbn - [ angle_mul_nat angle_div_2_pow ].
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle 5 3 (θ / ₂)) as H1.
              assert (H : 5 ≤ 2 ^ 3) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
              apply angle_nlt_ge in H1.
            ...
            destruct n. {
              cbn - [ angle_mul_nat angle_div_2_pow ].
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle 3 3 (θ / ₂)) as H1.
              assert (H : 3 ≤ 2 ^ 3) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
              apply angle_nlt_ge in H1.
            ...
            destruct (le_dec n 2) as [Hn2| Hn2]. {
              rewrite (Nat_div_less_small 2); [ | cbn; flia Hn2 ].
              rewrite angle_div_2_pow_succ_r_1.
              rewrite angle_div_2_mul_2.
              now apply (angle_div_2_not_straight Hc1).
            }
            apply Nat.nle_gt in Hn2.
            rewrite (Nat_div_less_small 1); [ | cbn; flia Hn2 Hni ].
            rewrite angle_mul_1_l.
            now apply (angle_div_2_not_straight Hc1).
          }
          destruct i. {
            ...
            destruct n. {
              cbn - [ angle_mul_nat angle_div_2_pow ].
              rewrite angle_div_2_pow_succ_r_2.
              specialize (angle_div_2_pow_mul_le_angle 10 4 (θ / ₂)) as H1.
              assert (H : 10 ≤ 2 ^ 4) by (cbn; flia).
              specialize (H1 H); clear H.
              intros Hxz.
              rewrite Hxz in H1.
              apply angle_nlt_ge in H1.
