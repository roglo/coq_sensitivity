...
What about {\em multiplication} of two angles? It seems not
...
seems to have no meaning. In this work, we did not define
multiplication of angles.

This has a consequence: it is not possible to define exponentiation of
imaginary angles either, like in the famous expression $e^{i\theta}$
of classical trigonometry, supposed to be equal to
