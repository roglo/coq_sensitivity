...
Having an addition is not enough, we need to prove it has the good
properties, i.e. that it is a group.

\subsection*{Commutativity}

Looking at the definition of addition, commutativity is trivial,
providing that commutativity of real numbers is true.

\subsection*{Associativity}

The proof of associativity is more complicated but had been done.

\subsection*{Neutral Element}

The neutral element is $(1, 0)$, the null angle. It says that
$cos\;0=1$ and $sin\;0=0$. It is easy to prove that for each angle
$\theta$, we have $(1, 0) + \theta = \theta + (1, 0) = \theta$.

\subsection*{Inverse Element}

The inverse element of $(x, y)$ is $(x, -y)$, expressing that $cos\;(-
