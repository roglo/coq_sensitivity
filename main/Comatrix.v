...
(* this code is temporarily here, in Comatrix.v, because some of my attempts
   use comatrices (Laplace formula), therefore cannot be in Determinant.v,
   but if the version with Cauchet-Binet formula works, the best is to make
   a file Binet-Formula.v *)
